...
    <div className="flex flex-col min-h-screen w-screen overflow-x-hidden bg-white">
      ...
      {/* ---------------------------------------------------- */}
      {/* NEW: Helmet component for SEO metadata for the course page */}
      {/* ---------------------------------------------------- */}
      <Helmet>
        <title>Beginner to Advanced Trading Course | Promic Education</title>
        <meta name="description" content="Enroll in the comprehensive 14-day Beginner to Advanced Trading Course. Learn SMC, ICT principles, and gain lifetime access to live trading sessions." />
        <link rel="canonical" href="https://yourdomain.com/courses" />
        
        {/* Open Graph (OG) Tags for Social Media Sharing */}
        <meta property="og:title" content="Beginner to Advanced Trading Course" />
        <meta property="og:description" content="Enroll in the comprehensive 14-day Beginner to Advanced Trading Course. Learn SMC, ICT principles, and gain lifetime access to live trading sessions." />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://yourdomain.com/courses" />
        {/* Replace with a high-quality preview image specific to the course */}
        <meta property="og:image" content="https://yourdomain.com/images/course-preview.jpg" /> 
...
          {/* Content */}
          <div className="relative z-10 text-gray-900 bg-white/70 p-6 sm:p-8 rounded-xl backdrop-blur-sm mx-auto max-w-4xl transition duration-1000">
...
            {/* Adjusted heading size for mobile */}
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-6">Free Educational Content (YouTube)</h2>
            <p className="text-gray-600 mb-8">Watch our latest videos and analysis sessions for free!</p>

            {/* Video Carousel Wrapper - Uses grid-cols-1 on mobile, 2 on sm, 4 on lg */}
            <div className="flex justify-center w-full">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-4 sm:gap-6 pb-4 max-w-6xl"> 
...
                      </div>
                    </div>
                    <p className="text-xs sm:text-sm font-semibold text-gray-800 truncate">{video.title}</p>
                  </a>
                ))}
              </div>
            </div>
...
                          bg-red-600 text-white font-semibold py-3 px-8 rounded-full text-base sm:text-lg w-full sm:w-auto 
...
        </section>
        
        {/* TikTok Video List Section */}
        <section className={`my-16 md:my-24 text-center transition-all duration-1000 ${visibleClass} delay-200`}>
            {/* Adjusted heading size for mobile */}
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-6">Free Educational Content (TikTok)</h2>
...
              rel="noopener noreferrer"
              className="mt-8 mx-auto inline-flex items-center justify-center 
                          bg-black text-white font-semibold py-3 px-8 rounded-full text-base sm:text-lg w-full sm:w-auto 
...
        <section className={`my-16 md:my-24 bg-gray-100 p-6 sm:p-8 rounded-2xl shadow-xl max-w-4xl mx-auto transition-all duration-1000 ${visibleClass} delay-[300ms]`}>
          {/* Adjusted heading size for mobile */}
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-8 text-center">
            Course Overview
            </h2>
          {/* Grid stacks on mobile (default grid-cols-1) */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 text-left">
            <div className="transition duration-700">
              {/* Adjusted heading size for mobile */}
              <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-4">What You Will Learn</h3>
...
            <div className="transition duration-700">
              {/* Adjusted heading size for mobile */}
              <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-4">Course Structure & Schedule</h3>
              <ul className="text-gray-600 text-sm sm:text-base space-y-2 list-disc list-inside">
...
              {/* Adjusted heading size for mobile */}
              <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mt-8 mb-4">Pricing & Packages</h3>
              {/* Pricing cards use grid-cols-1 on mobile */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Group Online Class */}
                <div className="bg-white p-6 rounded-lg shadow-md flex flex-col justify-between">
                  <div>
                    {/* Adjusted text size for mobile */}
                    <p className="text-base sm:text-lg font-semibold text-gray-800 mb-2">Group Online Class (Course Only)</p>
                    {/* Adjusted price size for mobile */}
                    <p className="text-2xl sm:text-3xl font-bold text-orange-600">Rs. 20,000/=</p>
                    <p className="text-gray-500 mt-2 text-sm sm:text-base">Perfect for learning with a community. (VIP Signals not included)</p>
                  </div>
...
                  <div>
                    {/* Adjusted text size for mobile */}
                    <p className="text-base sm:text-lg font-semibold text-gray-800 mb-2">Individual Online Class (Course Only)</p>
                    {/* Adjusted price size for mobile */}
                    <p className="text-2xl sm:text-3xl font-bold text-orange-600">Rs. 40,000/=</p>
                    <p className="text-gray-500 mt-2 text-sm sm:text-base">Personalized guidance and one-on-one support. (VIP Signals not included)</p>
                  </div>
...
            </div>
            
            {/* NEW Recommended Packages Section - Already responsive! */}
            <div className="md:col-span-2 mt-8 transition duration-700">
              {/* Adjusted heading size for mobile */}
              <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-6 border-b pb-2">RECOMMENDED PACKAGES</h3>
              <div className="space-y-4">
                {recommendedPackages.map((pkg, index) => (
                  // Uses flex-col on mobile, flex-row on small screens and up
...
                    {/* Inner content wrapper uses flex-col on mobile, flex-row on small screens and up */}
                    <div className="flex justify-between w-full flex-col sm:flex-row sm:items-center">
                        <span className="font-semibold text-gray-800 text-base sm:text-lg">{pkg.name}</span>
                        {/* Price/Discount/Button wrapper uses flex-col on mobile, flex-row on small screens and up */}
...
                            </div>
                            {/* Button uses w-full on mobile, auto-width on small screens and up */}
                            <a 
...
            {/* Adjusted heading size for mobile */}
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4">Join Our Public Community!</h2>
...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-green-600 text-white font-semibold py-3 px-8 rounded-full text-base sm:text-lg transition duration-300 transform hover:scale-105 hover:bg-white hover:text-green-600 hover:border-2 hover:border-green-600 inline-flex items-center justify-center w-full sm:w-auto"
            >
...
          {/* Adjusted heading size for mobile */}
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-4">Ready to Start Your Journey?</h2>
...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-orange-600 text-white font-semibold py-4 px-12 rounded-full text-lg transition duration-300 transform hover:scale-105 hover:bg-white hover:text-orange-600 hover:border-2 hover:border-orange-600 w-full sm:w-auto inline-block"
          >
            Enroll Now
          </a>
        </section>
